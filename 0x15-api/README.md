...
This project provided additional hands-on experience with APIs. I gathered data from the [JSONPlaceholder REST API](https://jsonplaceholder.typicode.com/) and acquired the skills to export it in either CSV or JSON format.
